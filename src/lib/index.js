 ...
 * @function getGrowAge -计算生日出生多久了
 * @function LeapYear -判断是否为闰年
 * @function DaysOfMonth -获取当月多少天
 * @function getdiffdate -获取区间日期
...
export function timestampToTime(timestamp, tyep) {
...
export function formatDuringDay (mss,hover,fen,miao) {
  // 计算还剩下多少时间PS秒
...
export function dataFormatT(value) {
  // 去掉时间戳的字母T
...
export function DaysOfMonth (dateStr) {
